...
虽然欢迎您提供自己的组织，但通常，基于COBRA的应用将遵循以下组织结构：
...
在Cobra应用中，通常main.go文件中是非常空的，只有一个目的，提供初始化Cobra服务
...
## Cobra生成器的使用 Using the Cobra Generator

Cobra提供自己的程序，这将使你可以创建自己的应用和添加任何你想要添加的命令，这是将Cobra加入你的应用最容易的方式
...
## Cobra库的使用 Using the Cobra Library
...
Cobra can generate documentation based on subcommands, flags, etc. Read more about it in the [docs generation documentation](https://github.com/spf13/cobra/blob/master/doc/README.md).

## Generating shell completions

Cobra can generate a shell-completion file for the following shells: bash, zsh, fish, PowerShell. If you add more information to your commands, these completions can be amazingly powerful and flexible. Read more about it in [Shell Completions](https://github.com/spf13/cobra/blob/master/shell_completions.md).